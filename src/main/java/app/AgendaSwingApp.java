			...
			public void run() {
				...
				try {
					if ((!interfaceType.equals("gui") && !interfaceType.equals("cli"))) {
						System.err.println(
								"Invalid value for optin --interface. Allowed values: are \"gui\" and \"cli\"");
						System.exit(1);
					}
					...
					TransactionManager transactionManager = new TransactionManagerMongo(mongoClient,
							studentMongoRepository, courseMongoRepository);
